...
class Publisher_Admin_Post extends Fbap_Admin {
	...
	public function publications_admin_menu() {
		add_submenu_page(
	...
	public function holiday_house_api_luksushuse() {
		echo 'lorem';
//		$luksushuse = new API( 'luksushuse' );
//		$luksushuse->display_api_page();
	}
}