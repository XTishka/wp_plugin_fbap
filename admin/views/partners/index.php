...
function show_index_partner( $data ) {
    ...
    <div id="wpbody-content">
        <div class="wrap">
            ...
            <a href="?page=fbap&tab=create-partner" class="page-title-action" style="display: none">Add New</a>
                        ...
                        <td class="username column-username has-row-actions column-primary" data-colname="Display name">
                            ...
                            <div class="row-actions">
                                ...
                                <span class="trash" style="display: none;">
                                    <a href="?page=fbap&tab=trash-partner&id=<?= $partner->id ?>" class="submitdelete">Trash</a>
                                </span>
                            </div>
                        </td>
